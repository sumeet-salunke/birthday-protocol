...
export default function Scene1_BlackScreen({ onComplete }) {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-[#02050a] relative overflow-hidden">
      ...
      >
        <div className="w-full h-full bg-black/80 backdrop-blur-sm rounded-lg border border-cyber-cyan/20 shadow-[0_0_60px_rgba(0,243,255,0.1)] overflow-hidden flex flex-col">
          {/* Terminal Header */}
