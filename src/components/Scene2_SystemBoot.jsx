  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-[#02050a] relative overflow-hidden">
      ...
      <Tilt
        ...
        glareColor="#00f3ff"
        glarePosition="all"
        className="relative z-10 w-[90%] max-w-3xl aspect-video"
      >
        <div className="w-full h-full bg-black/80 backdrop-blur-sm rounded-lg border border-cyber-cyan/20 shadow-[0_0_60px_rgba(0,243,255,0.15)] flex flex-col overflow-hidden">
          {/* Terminal Header */}
